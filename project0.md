...
Memcached Cloud is a fully-managed service for hosting and running Redis in a high availability and scalable manner.
...
Scalable data partitioning across cluster, providing fault tolerance and to accommodate distributed applications/computations;
Support for access to caches either transactionally or non-transactionally;
Schema-less key/value to overcome the constraints of traditional database.
...
Building Scalable Applications in .NET: Introducing the FatDB Distributed Computing Platform, http://www.infoq.com/articles/fatdb
...
Oracle and DB2, Comparison and Compatibility,  http://en.wikibooks.org/wiki/Oracle_and_DB2,_Comparison_and_Compatibility
...
**Strength**
An open-source, distributed, versioned, non-relational, column-oriented database modeled after Google's Bigtable on top of Hadoop and HDFS;
